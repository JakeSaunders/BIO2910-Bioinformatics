...
download.file(
    url = "https://raw.githubusercontent.com/JakeSaunders/BIO2910-Bioinformatics/refs/heads/main/Bio2910-03-Assignment05-Finches.csv",
    destfile = "Bio2910-03-Assignment05-Finches.csv"
    )

# ...And read the file into R with the following code
# In this table Weight is recorded in grams, all other measurements are cm.

finches <- read.csv("Bio2910-03-Assignment05-Finches.csv")
...
#### Part 4) [Optional] If you would like to get some more practice with R ----
