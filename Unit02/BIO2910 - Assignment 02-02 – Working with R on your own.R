# Before you do anything else in R we need to make sure that R-studio is looking
# at the right place to save and retrieve files this is similar to how you use the 
# file explorer to specific files you have save on your computer. To tell R which 
# directory the files are in (called setting your working directory).
# I have written code which does this for you but you need to run it.
# To run it follow the directions on lines 8 to 10, and 12 to 14.

# <---------    Highlight from this line...
setwd("/cloud/project/BIO2910/Unit02/")
# <---------    to this line.
...
# You run code from this window by highlighting it and pressing CTRL+ENTER or the run button
# in the upper right of this window.
...
#1) Copy your input and output from the terminal below into the word document answer sheet.
...
my.strings <- c("You","Even","A","of","These", "My", "combined")

my.other.strings <- c("Can","Make","List","strings.","Are", "Strings", "together.")
...
# Then after reading the help document use paste(), my.strings, my.other.strings and 
# one of the arguments to write a line of code to produce the following output:

"You Can Even Make A List of strings. These Are My Strings combined together."
...
#### Part 3) Plotting your own graph  ----
...
# explore at the data you assigned to the variable finches by using
# functions like str(), dim(), pairs(), class()



# Now based on what you have observed in  this data set and using what you know 
# about R write code to make 2 good graphs. Save those graphs using the export 
# command in the "Plots" panel. Make sure to customize the way the graph look
